...
{
    cout << ("\t\t\tМеню") << endl;
    cout << ("1) Многопоточная реализация алгоритма поиска расстояния Левенштейна.") << endl;
    cout << ("2) Многопоточная реализация оптимизированного алгоритма поиска расстояния Левенштейна.") << endl;
}
